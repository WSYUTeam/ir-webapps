...
<dspace:layout locbar="off" titlekey="jsp.error.download.title">

    <%-- <h1>Authorization Required</h1> --%>
    <h1><fmt:message key="jsp.error.download.title"/></h1>

    <%-- <p>You do not have permission to perform the action you just attempted.</p> --%>
    <p><fmt:message key="jsp.error.download.text1"/></p>

    <%-- <p>If you think you should have authorization, please feel free to
    contact the DSpace administrators:</p> --%>
    <p><fmt:message key="jsp.error.download.text2"/></p>
