...
<dspace:layout style="submission" titlekey="jsp.dspace-admin.researcher.title"
	...
	%>
	<form method="post" action="<%=request.getContextPath()%>/dspace-admin/researcher?action=<%=(r!=null?("update&uid="+r.getUid()):"add") %>" enctype="multipart/form-data" onsubmit="return checkForm();">
		...
		<fieldset id="fieldset_store">		
			...
			<dl>								
				...
				<dd>
					<input type="text" value="<%=(r!=null?r.getUid():"") %>" <%=(r!=null?"readonly='readonly'":"") %> size="100" name="uid" maxlength="100" id="uid" autocomplete="off">
				</dd>
				
				<dt><label for="account_store_name"><fmt:message key="jsp.dspace-admin.researcher.form.name"/>(*)</label></dt>
				<dd>
					<input type="text" value="<%=(r!=null?r.getName():"") %>" size="100" name="name" maxlength="100" id="name" autocomplete="off">
				</dd>
				
				<dt><label for="account_store_name"><fmt:message key="jsp.dspace-admin.researcher.form.orcid"/></label></dt>
				<dd>
					<input type="text" value="<%=(r!=null?r.getOrcid():"") %>" size="100" name="orcid" maxlength="100" id="orcid" autocomplete="off">
				</dd>
				
				<dt><label for="account_store_name"><fmt:message key="jsp.dspace-admin.researcher.form.academic-name"/></label></dt>
				<dd>
					<input type="text" value="<%=(r!=null?r.getAcademicName():"") %>" size="100" name="academicName" maxlength="100" id="academicName" autocomplete="off">
				...
				<dd>
					<input type="radio" name="sex" id="sex" value="1" style="width: 50px;"/><div style="float: left; width: 100px;"><fmt:message key="jsp.dspace-admin.researcher.form.sex.male" /></div><input
					type="radio" name="sex" id="sex" value="0" style="width: 50px;"/><div style="float: left; width: 100px;"><fmt:message key="jsp.dspace-admin.researcher.form.sex.female" /></div>
				</dd>
				
				<dt><label for="account_store_name"><fmt:message key="jsp.dspace-admin.researcher.form.title"/>(*)</label></dt>
				<dd>
					<input type="text" value="<%=(r!=null?r.getTitle():"") %>" size="100" name="title" maxlength="100" id="title" autocomplete="off">
				</dd>
				...
				<dd>
					...
					<p><fmt:message key="jsp.dspace-admin.researcher.form.unit.tip1"/> <a href="<%=request.getContextPath()%>/community-list"><fmt:message key="jsp.dspace-admin.researcher.form.unit.tip2"/></a></p>
				</dd>		
				
				<dt><label for="account_store_name"><fmt:message key="jsp.dspace-admin.researcher.form.field"/>(*)</label></dt>
				<dd>
					<input type="text" value="<%=(r!=null?r.getField():"") %>" size="100" name="field" maxlength="100" id="field" autocomplete="off">
				</dd>
				
				<dt><label for="account_store_name"><fmt:message key="jsp.dspace-admin.researcher.form.education"/></label></dt>
				<dd>
					<input type="text" value="<%=(r!=null?(r.getEducation()==null?"":r.getEducation()):"") %>" size="100" name="education" maxlength="100" id="education" autocomplete="off">
				</dd>
