...
<% 
	...
	<div class="form-group">
			...
			<div class="col-md-7"> 
			<input class="form-control submission-file-loader" type="file" name="file_upload" id="file_upload" />&nbsp;<a style="color:#428bca;" href="<%=request.getContextPath() %>/help/sample_files_dspace_bte.zip" target="_blank"><fmt:message key="jsp.submit.start-lookup-submission.byfile.example"/></a>
			</div>
	</div>
